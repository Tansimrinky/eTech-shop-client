    ...
    <div>
      <div className="carousel w-full h-[500px] my-5">
        <div id="slide1" className="carousel-item relative w-full ">
          <img
            src="https://i.ibb.co/LnJVT90/8249495.jpg"
        ...
        <div id="slide4" className="carousel-item relative w-full">
          <img
            src="https://i.ibb.co/B3w5gWc/xiaomi-pad-5-500x500.jpghttps://i.ibb.co/yXQ05n7/1000-F-227367814-Gu-XU3oo37ltn6c-Wcvl-Tn-LDi-Ka8kx-Ki-JR.jpg"
            className="w-full"
          />
          <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
            <a href="#slide3" className="btn btn-circle">
